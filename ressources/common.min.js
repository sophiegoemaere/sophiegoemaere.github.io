!(function (_) {
    ...
    _(window).on("load", function () {
                    ...
                    _.getScript(e, function (e, s, i) {
                        t.each(function () {
                            var e = _(this),
                                ...
                                i = {
                                    zoom: 14,
                                    center: { lat: 50.679320, lng: 3.063450 },
                                    disableDefaultUI: !0,
                            ...
                            new google.maps.Marker({ map: t, icon: { size: new google.maps.Size(59, 69), origin: new google.maps.Point(0, 0), anchor: new google.maps.Point(0, 69), url: s }, position: { lat: 50.679320, lng:3.063450 } });
        ...
        jQuery(document).ready(function () {
            console.log("dede");
            $("#home-picture").css("width", $( window ).width());
